  ...
  public class Program
  {
    ...
    static void Setup()
    {
      ...
      if (SelectedAccessType == AccessType.PinCode)
        ...
        settings.UseBasicAuthenticationForClient = true;
    ...
    {
      Console.WriteLine("Now loading certificate from " + JWT_CertificatePath);
